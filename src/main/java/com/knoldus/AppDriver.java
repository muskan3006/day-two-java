...
public class AppDriver {
    public static void main(String[] args) throws IOException {
        ...
        List<Student> listOfStudents = Arrays.asList(new Student(1, "Pushkar", 20, new Address("Delhi", "Sarita Vihar")),
        ...
        System.out.println(a.getTimeFromTimeZone("America/Los_Angeles"));
